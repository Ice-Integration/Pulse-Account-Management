...
from pulse_account_management.SimulationEngine import file_utils
...
class TestFileUtils(unittest.TestCase):
    ...
    def test_read_file_nonexistent_file(self):
        ...
        with self.assertRaisesRegex(
            FileNotFoundError, re.escape(f"File not found: {self.test_nonexistent_file}")
        ):
            file_utils.read_file(file_path=self.test_nonexistent_file)
    ...
    def test_encode_file_to_base64_nonexistent_file(self):
        ...
        with self.assertRaisesRegex(
            ...
            file_utils.encode_file_to_base64(file_path=self.test_nonexistent_file)
