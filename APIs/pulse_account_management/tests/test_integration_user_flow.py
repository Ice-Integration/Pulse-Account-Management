...
class TestAccountManagementIntegration(unittest.TestCase):
    """
    Integration test suite for the 'pulse_account_management' service.
    ...
    def setUp(self):
        ...
        db.DB["availablePlans"]["plans"] = {
            self.initial_plan_id: {
                ...
                "description": "Entry-level plan used as the starting state for the test.",
                "monthlyCost": 45.00,
                "type": "PLAN",
                "dataAllowance": "15GB",
            },
    ...
    def test_integration_workflow_change_plan(self, mock_get_gemini_response):
        ...
        plan_query_result = query_available_plans_and_features(query="Unlimited Plan")
