...
from pulse_account_management.SimulationEngine import utils
from pulse_account_management.SimulationEngine.custom_errors import ActionNotSupportedError
...
class TestAccountManagementUtils(AccountManagementBaseTestCase):
    ...
    def test_create_account_missing_account_id(self):
        ...
        account_data = {"customerName": "John Doe", "email": "john.doe@example.com"}

        with self.assertRaisesRegex(ValueError, re.escape("Account ID is required")):
            utils.create_account(account_data=account_data)
    ...
    def test_create_account_initializes_account_details(self):
        ...
        account_data = {"accountId": "ACCT-99999", "customerName": "Test User"}
    ...
    def test_create_account_minimal_data(self):
        ...
        account_data = {"accountId": "ACCT-MINIMAL"}
    ...
    def test_create_account_complex_data(self):
        ...
        account_data = {
            ...
            "preferences": {"notifications": True, "billing": "paperless"},
        }
    ...
    def test_create_account_multiple_accounts(self):
        ...
        accounts = [
            {"accountId": "ACCT-MULTI-1", "customerName": "User One", "email": "user1@example.com"},
            {"accountId": "ACCT-MULTI-2", "customerName": "User Two", "email": "user2@example.com"},
            {
    ...
    def test_add_device_to_account_nonexistent_account(self):
        ...
        device_data = {"deviceId": "DEV-TEST-001", "deviceName": "Test Device"}
        with self.assertRaisesRegex(ValueError, re.escape("Account NONEXISTENT-ACCOUNT not found")):
            utils.add_device_to_account(account_id="NONEXISTENT-ACCOUNT", device_data=device_data)

    def test_add_device_to_account_missing_device_id(self):
        """Test adding device without deviceId raises ValueError."""
        account_id = "ACC888777666"
        device_data = {"deviceName": "Test Device", "deviceType": "smartphone"}

        with self.assertRaisesRegex(ValueError, re.escape("Device ID is required")):
            utils.add_device_to_account(account_id=account_id, device_data=device_data)

    def test_add_device_to_account_empty_device_id(self):
        """Test adding device with empty deviceId raises ValueError."""
        account_id = "ACC888777666"
        device_data = {"deviceId": "", "deviceName": "Test Device"}
    ...
    def test_add_device_to_account_none_device_id(self):
        ...
        account_id = "ACC888777666"
        device_data = {"deviceId": None, "deviceName": "Test Device"}
    ...
    def test_add_device_to_account_initializes_devices_list(self):
        ...
        account_data = {"accountId": "ACCT-NO-DEVICES", "customerName": "No Devices User"}
    ...
    def test_add_device_to_account_multiple_devices(self):
        ...
        account_data = {"accountId": "ACCT-MULTI-DEV", "customerName": "Multi Device User"}
        utils.create_account(account_data)

        devices = [
            {"deviceId": "DEV-MULTI-001", "deviceName": "iPhone 15", "deviceType": "smartphone"},
            {"deviceId": "DEV-MULTI-002", "deviceName": "iPad Pro", "deviceType": "tablet"},
            {"deviceId": "DEV-MULTI-003", "deviceName": "Apple Watch", "deviceType": "wearable"},
        ]
    ...
    def test_add_device_to_account_minimal_device_data(self):
        ...
        account_id = "ACC888777666"
        device_data = {"deviceId": "DEV-MINIMAL-001"}
    ...
    def test_add_device_to_account_complex_device_data(self):
        ...
        device_data = {
            ...
            "plan": {"planId": "PLAN-001", "dataLimit": "unlimited"},
        }
    ...
    def test_add_device_to_account_duplicate_device_id(self):
        ...
        account_id = "ACC888777666"
        device_data = {"deviceId": "DEV-DUPLICATE-001", "deviceName": "First Device"}
    ...
    def test_add_device_to_account_preserves_existing_devices(self):
        ...
        # Add new device
        new_device = {"deviceId": "DEV-PRESERVE-001", "deviceName": "New Device"}
        ...
        self.assertTrue(
            any(
                d.get("deviceId") == "DEV-PRESERVE-001" and d.get("deviceName") == "New Device"
    ...
    def test_add_service_to_account_nonexistent_account(self):
        ...
        service_data = {"serviceId": "SVC-TEST-001", "serviceName": "Test Service"}

        with self.assertRaisesRegex(ValueError, re.escape("Account NONEXISTENT-ACCOUNT not found")):
            utils.add_service_to_account(
                account_id="NONEXISTENT-ACCOUNT", service_data=service_data
            )

    def test_add_service_to_account_missing_service_id(self):
        """Test adding service without serviceId raises ValueError."""
        account_id = "ACC888777666"
        service_data = {"serviceName": "Test Service", "serviceType": "data"}

        with self.assertRaisesRegex(ValueError, re.escape("Service ID is required")):
            utils.add_service_to_account(account_id=account_id, service_data=service_data)

    def test_add_service_to_account_empty_service_id(self):
        """Test adding service with empty serviceId raises ValueError."""
        account_id = "ACC888777666"
        service_data = {"serviceId": "", "serviceName": "Test Service"}
    ...
    def test_add_service_to_account_none_service_id(self):
        ...
        account_id = "ACC888777666"
        service_data = {"serviceId": None, "serviceName": "Test Service"}
    ...
    def test_add_service_to_account_initializes_services_list(self):
        ...
        account_data = {"accountId": "ACCT-NO-SERVICES", "customerName": "No Services User"}
        utils.create_account(account_data)
    ...
    def test_add_service_to_account_multiple_services(self):
        ...
        # Create a clean account for this test
        account_data = {"accountId": "ACCT-MULTI-SVC", "customerName": "Multi Service User"}
        utils.create_account(account_data)
    ...
    def test_add_service_to_account_minimal_service_data(self):
        ...
        account_id = "ACC888777666"
        service_data = {"serviceId": "SVC-MINIMAL-001"}
    ...
    def test_add_service_to_account_complex_service_data(self):
        ...
        service_data = {
            ...
            "features": ["unlimited_calls", "priority_support", "5G_access"],
            "limits": {
                "dataGB": "unlimited",
    ...
    def test_add_service_to_account_preserves_existing_services(self):
        ...
        # Add new service
        new_service = {"serviceId": "SVC-PRESERVE-001", "serviceName": "New Service"}
    ...
    def test_create_order_effective_date_next_day(self):
        ...
        expected_effective = created_date.replace(
    ...
    def test_create_order_action_not_supported(self):
        ...
        with self.assertRaisesRegex(
            ActionNotSupportedError, re.escape("Action UNSUPPORTED_ACTION not supported.")
        ):
            utils.create_order(
                account_id=account_id, action="UNSUPPORTED_ACTION", message="Action not supported"
            )
    ...
    def test_search_plans_by_query_v2_empty_string(self):
        ...
        with self.assertRaisesRegex(ValueError, re.escape("Query must be a non-empty string")):
            utils.search_plans_by_query(query="")

    def test_search_plans_by_query_v2_invalid_input(self):
        """Test search_plans_by_query_v2 with invalid input types."""
        with self.assertRaisesRegex(ValueError, re.escape("Query must be a non-empty string")):
            utils.search_plans_by_query(query=None)

        with self.assertRaisesRegex(ValueError, re.escape("Query must be a non-empty string")):
            utils.search_plans_by_query(query=123)
