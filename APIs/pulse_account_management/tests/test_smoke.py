...
from pulse_account_management.SimulationEngine.custom_errors import AccountNotFoundError
...
class TestAccountManagementSmoke(AccountManagementBaseTestCase):
    ...
    def test_end_to_end_account_retrieval(self):
        ...
        from pulse_account_management import get_customer_account_details
    ...
    def test_end_to_end_device_upgrade_check(self):
        ...
        from pulse_account_management import check_device_upgrade_eligibility
    ...
    def test_basic_error_handling(self):
        ...
        with self.assertRaisesRegex(
            AccountNotFoundError, re.escape("Account INVALID-ACCOUNT-ID not found in the database.")
        ):
            get_customer_account_details(accountId="INVALID-ACCOUNT-ID")
    ...
    def test_model_instantiation_smoke(self):
        ...
        communicationPreferences = CommunicationPreferences(emailOptIn=True, smsOptIn=True)
